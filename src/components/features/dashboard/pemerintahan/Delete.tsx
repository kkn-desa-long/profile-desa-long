...
interface DeleteVillageGovernmentProps {
  selectedItem: Tables<"village_government">;
  state: {
    status: string;
    errors?: {
      id?: string[];
...
export default function DeleteVillageGovernment({
  selectedItem,
  state,
  formAction,
  isPending,
  onCancel,
}: DeleteVillageGovernmentProps) {
  return (
    <div className="mt-4">
